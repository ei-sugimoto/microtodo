...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/ei-sugimoto/microtodo/server/member/gen/health/v1"
	http "net/http"
	strings "strings"
)
...
var (
	...
	healthServiceHealthMethodDescriptor = healthServiceServiceDescriptor.Methods().ByName("Health")
)
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	return &healthServiceClient{
		health: connect.NewClient[v1.HealthRequest, v1.HealthResponse](
			...
			connect.WithSchema(healthServiceHealthMethodDescriptor),
